...
class MobData(BaseModel):
    accuracy = IntegerField()
    avoidability = IntegerField()
    carnival_points = UnknownField()  # tinyint(3)
    chase_speed = IntegerField()
    damaged_by_mob_only = IntegerField()
    damaged_by_skill_only = IntegerField()
    death_after = IntegerField()
    death_buff = IntegerField()
    drop_item_period = IntegerField()
    experience = IntegerField()
    ...
    hp = IntegerField()
    hp_bar_bg_color = UnknownField()  # tinyint(3)
    hp_bar_color = UnknownField()  # tinyint(3)
    hp_recovery = IntegerField()
    ice_modifier = TextField()
    knockback = IntegerField()
    lightning_modifier = TextField()
    link = IntegerField()
    magical_attack = IntegerField()
    magical_defense = IntegerField()
    mob_level = IntegerField()
    ...
    traction = UnknownField()  # double(3,1)
